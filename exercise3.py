...
class Rectangle:
    ...
    # def contains(self, point: Point2D) -> bool:
        ...
        #         and reuse that here.
        return self.is_in_interval(point.x,self._lower_left.x, self._dx, tolerance) \
            and self.is_in_interval(point.y,self._lower_left.y, self._dy, tolerance)
    ...
    def is_in_interval(self, value: float, lower: float, length: float, tolerance: float = 0.0) -> bool:
        ll = value - lower
        return ll >= -1*tolerance and ll <= length + tolerance 
