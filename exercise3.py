...
class Rectangle:
    ...
    def contains(self, point: Point2D) -> bool:
        ...
        #         and reuse that here.
        return self.is_in_interval(point.x,self._lower_left.x, self._dx) \
            and self.is_in_interval(point.y,self._lower_left.y, self._dy)
    ...
    def is_in_interval(self, value: float, lower: float, length: float) -> bool:
        return lower <= value and value <= length + lower
